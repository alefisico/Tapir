...
config.General.requestName = 'TTToDiLeptonic_TuneCP5_PSweights_13TeV-powhel_NLOPS-pythia8'
...
config.Data.outputPrimaryDataset = 'TTToDiLeptonic_TuneCP5_PSweights_13TeV-powhel_NLOPS-pythia8'
