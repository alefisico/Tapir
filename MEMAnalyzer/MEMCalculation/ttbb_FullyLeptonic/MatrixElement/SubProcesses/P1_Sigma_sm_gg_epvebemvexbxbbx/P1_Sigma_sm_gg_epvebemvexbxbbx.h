...
class P1_Sigma_sm_gg_epvebemvexbxbbx: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_sm_gg_epvebemvexbxbbx(const ParameterSet& configuration); 
    virtual ~P1_Sigma_sm_gg_epvebemvexbxbbx() {}; 
  ...
  private:
    ...
    P1_Sigma_sm_gg_epvebemvexbxbbx() = delete; 
    ...
    std::complex<double> amp[45]; 

    // Matrix elements
    double matrix_1_gg_ttxbbx_t_wpb_wp_epve_tx_wmbx_wm_emvex(); 
    double matrix_1_uux_ttxbbx_t_wpb_wp_epve_tx_wmbx_wm_emvex(); 
    double matrix_1_gg_ttxbbx_t_wpb_wp_mupvm_tx_wmbx_wm_mumvmx(); 
    double matrix_1_uux_ttxbbx_t_wpb_wp_mupvm_tx_wmbx_wm_mumvmx(); 
    double matrix_1_gg_ttxbbx_t_wpb_wp_mupvm_tx_wmbx_wm_emvex(); 
    double matrix_1_uux_ttxbbx_t_wpb_wp_mupvm_tx_wmbx_wm_emvex(); 
    double matrix_1_gg_ttxbbx_t_wpb_wp_epve_tx_wmbx_wm_mumvmx(); 
    double matrix_1_uux_ttxbbx_t_wpb_wp_epve_tx_wmbx_wm_mumvmx(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_sm_gg_epvebemvexbxbbx >> > mapFinalStates;
