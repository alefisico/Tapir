...
--load_modules('/mnt/t3nfs01/data01/shome/algomez/work/Generation/MG5_aMC_v2_6_1/ttH_dileptonic/build/libme_ttH_dileptonic.so')
load_modules('/mnt/t3nfs01/data01/shome/algomez/work/Generation/MG5_aMC_v2_6_1/ttH_Hbb_dilepTops/build/libme_ttH_Hbb_dilepTops.so')
...
--DoubleGaussianTransferFunctionOnPt.tf_top_bjet1 = {
--    ps_point = add_dimension(),
--    reco_particle = top_bjet1.reco_p4,
--}
...
Looper.higgs_looper = {
    ...
    Looper.tt_looper = {
        ...
        MatrixElement.ttH_me = {
          ...
          --matrix_element = 'ttH_dileptonic_sm_P1_Sigma_sm_gg_epvebemvexbxbbx',
          matrix_element = 'ttH_Hbb_dilepTops_sm_P1_Sigma_sm_gg_epvebemvexbxbbx',

          matrix_element_parameters = {
              --card = '/mnt/t3nfs01/data01/shome/algomez/work/Generation/MG5_aMC_v2_6_1/ttH_dileptonic/Cards/param_card.dat'
              card = '/mnt/t3nfs01/data01/shome/algomez/work/Generation/MG5_aMC_v2_6_1/ttH_Hbb_dilepTops/Cards/param_card.dat'
          },
          ...
          -- me_index is found in Subprocesses/blah.cc in mapFinalStates
          particles = {
            inputs = full_inputs,
            ids = {
              {
