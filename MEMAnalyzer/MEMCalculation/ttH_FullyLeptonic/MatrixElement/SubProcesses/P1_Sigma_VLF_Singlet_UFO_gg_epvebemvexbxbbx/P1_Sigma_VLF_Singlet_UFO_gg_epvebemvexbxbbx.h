...
class P1_Sigma_VLF_Singlet_UFO_gg_epvebemvexbxbbx: public
    momemta::MatrixElement
{
  public:

    // Constructor & destructor
    P1_Sigma_VLF_Singlet_UFO_gg_epvebemvexbxbbx(const ParameterSet&
        configuration);
    virtual ~P1_Sigma_VLF_Singlet_UFO_gg_epvebemvexbxbbx() {}; 
  ...
  private:
    ...
    P1_Sigma_VLF_Singlet_UFO_gg_epvebemvexbxbbx() = delete; 
    ...
    // Matrix elements
    double matrix_1_gg_ttxh_t_wpb_wp_epve_tx_wmbx_wm_emvex_h_bbx(); 
    double matrix_1_uux_ttxh_t_wpb_wp_epve_tx_wmbx_wm_emvex_h_bbx(); 
    double matrix_1_ccx_ttxh_t_wpb_wp_epve_tx_wmbx_wm_emvex_h_bbx(); 
    double matrix_1_ddx_ttxh_t_wpb_wp_epve_tx_wmbx_wm_emvex_h_bbx(); 
    double matrix_1_ssx_ttxh_t_wpb_wp_epve_tx_wmbx_wm_emvex_h_bbx(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_VLF_Singlet_UFO_gg_epvebemvexbxbbx >> > mapFinalStates;
