    ...
    std::complex<double> COUP, double M3, double W3, std::complex<double> V3[])
{
  ...
  denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  V3[2] = denom * (-cI) * (F2[4] * F1[2] + F2[5] * F1[3] - P3[0] * OM3 * TMP9); 
  V3[3] = denom * (-cI) * (-F2[4] * F1[3] - F2[5] * F1[2] - P3[1] * OM3 *
      TMP9);
  V3[4] = denom * (-cI) * (-cI * (F2[5] * F1[2]) + cI * (F2[4] * F1[3]) - P3[2]
      * OM3 * TMP9);
  V3[5] = denom * (-cI) * (F2[5] * F1[3] - F2[4] * F1[2] - P3[3] * OM3 * TMP9); 
}
    ...
    COUP, std::complex<double> & vertex)
{
  ...
  TMP13 = (V1[2] * V4[2] - V1[3] * V4[3] - V1[4] * V4[4] - V1[5] * V4[5]); 
  TMP6 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]); 
  TMP10 = (V2[2] * V4[2] - V2[3] * V4[3] - V2[4] * V4[4] - V2[5] * V4[5]); 
  TMP3 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]); 
  vertex = COUP * (-cI * (TMP6 * TMP13) + cI * (TMP3 * TMP10)); 
}
    ...
    COUP, std::complex<double> & vertex)
{
  ...
  TMP1 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  TMP13 = (V1[2] * V4[2] - V1[3] * V4[3] - V1[4] * V4[4] - V1[5] * V4[5]); 
  vertex = COUP * (-cI * (TMP6 * TMP13) + cI * (TMP1 * TMP11)); 
}
