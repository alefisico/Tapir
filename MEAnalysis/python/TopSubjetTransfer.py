...
for i in range(tree.GetEntries()):
    ...
    FatjetCA15SoftDropSubjet = nanoTreeClasses.FatjetCA15SoftDropSubjet.make_array(tree, MC = True)
 

    #print len(GenLepFromTop), len(GenWZQuark)
