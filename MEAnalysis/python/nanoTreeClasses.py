...
class Jet:
    def __init__(self, tree, n, MC):
        ...
        self.corr_JERUp = tree.Jet_pt_jerUp[n]/tree.Jet_pt[n];
        self.corr_JERDown = tree.Jet_pt_jerDown[n]/tree.Jet_pt[n];

        #tree.Jet_pt_jes* in nanoAOD is the rawPt * JES * JER * (1 - delta) for * variation
        #The code expects it to be the full JES+variation correction the nominal JES part is removed from self.pt for Jet_pt_nom[n]
        self.corr_AbsoluteStatUp = tree.Jet_pt_jesAbsoluteStatUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_AbsoluteScaleUp = tree.Jet_pt_jesAbsoluteScaleUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_AbsoluteFlavMapUp = tree.Jet_pt_jesAbsoluteFlavMapUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_AbsoluteMPFBiasUp = tree.Jet_pt_jesAbsoluteMPFBiasUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FragmentationUp = tree.Jet_pt_jesFragmentationUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SinglePionECALUp = tree.Jet_pt_jesSinglePionECALUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SinglePionHCALUp = tree.Jet_pt_jesSinglePionHCALUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FlavorQCDUp = tree.Jet_pt_jesFlavorQCDUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TimePtEtaUp = tree.Jet_pt_jesTimePtEtaUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeJEREC1Up = tree.Jet_pt_jesRelativeJEREC1Up[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeJEREC2Up = tree.Jet_pt_jesRelativeJEREC2Up[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeJERHFUp = tree.Jet_pt_jesRelativeJERHFUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativePtBBUp = tree.Jet_pt_jesRelativePtBBUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativePtEC1Up = tree.Jet_pt_jesRelativePtEC1Up[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativePtEC2Up = tree.Jet_pt_jesRelativePtEC2Up[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativePtHFUp = tree.Jet_pt_jesRelativePtHFUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeBalUp = tree.Jet_pt_jesRelativeBalUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeFSRUp = tree.Jet_pt_jesRelativeFSRUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeStatFSRUp = tree.Jet_pt_jesRelativeStatFSRUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeStatECUp = tree.Jet_pt_jesRelativeStatECUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeStatHFUp = tree.Jet_pt_jesRelativeStatHFUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpDataMCUp = tree.Jet_pt_jesPileUpDataMCUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpPtRefUp = tree.Jet_pt_jesPileUpPtRefUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpPtBBUp = tree.Jet_pt_jesPileUpPtBBUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpPtEC1Up = tree.Jet_pt_jesPileUpPtEC1Up[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpPtEC2Up = tree.Jet_pt_jesPileUpPtEC2Up[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpPtHFUp = tree.Jet_pt_jesPileUpPtHFUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpMuZeroUp = tree.Jet_pt_jesPileUpMuZeroUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpEnvelopeUp = tree.Jet_pt_jesPileUpEnvelopeUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SubTotalPileUpUp = tree.Jet_pt_jesSubTotalPileUpUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SubTotalRelativeUp = tree.Jet_pt_jesSubTotalRelativeUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SubTotalPtUp = tree.Jet_pt_jesSubTotalPtUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SubTotalScaleUp = tree.Jet_pt_jesSubTotalScaleUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SubTotalAbsoluteUp = tree.Jet_pt_jesSubTotalAbsoluteUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SubTotalMCUp = tree.Jet_pt_jesSubTotalMCUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TotalUp = tree.Jet_pt_jesTotalUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TotalNoFlavorUp = tree.Jet_pt_jesTotalNoFlavorUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TotalNoTimeUp = tree.Jet_pt_jesTotalNoTimeUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TotalNoFlavorNoTimeUp = tree.Jet_pt_jesTotalNoFlavorNoTimeUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FlavorZJetUp = tree.Jet_pt_jesFlavorZJetUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FlavorPhotonJetUp = tree.Jet_pt_jesFlavorPhotonJetUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FlavorPureGluonUp = tree.Jet_pt_jesFlavorPureGluonUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FlavorPureQuarkUp = tree.Jet_pt_jesFlavorPureQuarkUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FlavorPureCharmUp = tree.Jet_pt_jesFlavorPureCharmUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FlavorPureBottomUp = tree.Jet_pt_jesFlavorPureBottomUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TimeRunBUp = tree.Jet_pt_jesTimeRunBUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TimeRunCUp = tree.Jet_pt_jesTimeRunCUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TimeRunDUp = tree.Jet_pt_jesTimeRunDUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TimeRunEUp = tree.Jet_pt_jesTimeRunEUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TimeRunFUp = tree.Jet_pt_jesTimeRunFUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_CorrelationGroupMPFInSituUp = tree.Jet_pt_jesCorrelationGroupMPFInSituUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_CorrelationGroupIntercalibrationUp = tree.Jet_pt_jesCorrelationGroupIntercalibrationUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_CorrelationGroupbJESUp = tree.Jet_pt_jesCorrelationGroupbJESUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_CorrelationGroupFlavorUp = tree.Jet_pt_jesCorrelationGroupFlavorUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_CorrelationGroupUncorrelatedUp = tree.Jet_pt_jesCorrelationGroupUncorrelatedUp[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_AbsoluteStatDown = tree.Jet_pt_jesAbsoluteStatDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_AbsoluteScaleDown = tree.Jet_pt_jesAbsoluteScaleDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_AbsoluteFlavMapDown = tree.Jet_pt_jesAbsoluteFlavMapDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_AbsoluteMPFBiasDown = tree.Jet_pt_jesAbsoluteMPFBiasDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FragmentationDown = tree.Jet_pt_jesFragmentationDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SinglePionECALDown = tree.Jet_pt_jesSinglePionECALDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SinglePionHCALDown = tree.Jet_pt_jesSinglePionHCALDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FlavorQCDDown = tree.Jet_pt_jesFlavorQCDDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TimePtEtaDown = tree.Jet_pt_jesTimePtEtaDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeJEREC1Down = tree.Jet_pt_jesRelativeJEREC1Down[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeJEREC2Down = tree.Jet_pt_jesRelativeJEREC2Down[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeJERHFDown = tree.Jet_pt_jesRelativeJERHFDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativePtBBDown = tree.Jet_pt_jesRelativePtBBDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativePtEC1Down = tree.Jet_pt_jesRelativePtEC1Down[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativePtEC2Down = tree.Jet_pt_jesRelativePtEC2Down[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativePtHFDown = tree.Jet_pt_jesRelativePtHFDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeBalDown = tree.Jet_pt_jesRelativeBalDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeFSRDown = tree.Jet_pt_jesRelativeFSRDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeStatFSRDown = tree.Jet_pt_jesRelativeStatFSRDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeStatECDown = tree.Jet_pt_jesRelativeStatECDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_RelativeStatHFDown = tree.Jet_pt_jesRelativeStatHFDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpDataMCDown = tree.Jet_pt_jesPileUpDataMCDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpPtRefDown = tree.Jet_pt_jesPileUpPtRefDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpPtBBDown = tree.Jet_pt_jesPileUpPtBBDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpPtEC1Down = tree.Jet_pt_jesPileUpPtEC1Down[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpPtEC2Down = tree.Jet_pt_jesPileUpPtEC2Down[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpPtHFDown = tree.Jet_pt_jesPileUpPtHFDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpMuZeroDown = tree.Jet_pt_jesPileUpMuZeroDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_PileUpEnvelopeDown = tree.Jet_pt_jesPileUpEnvelopeDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SubTotalPileUpDown = tree.Jet_pt_jesSubTotalPileUpDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SubTotalRelativeDown = tree.Jet_pt_jesSubTotalRelativeDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SubTotalPtDown = tree.Jet_pt_jesSubTotalPtDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SubTotalScaleDown = tree.Jet_pt_jesSubTotalScaleDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SubTotalAbsoluteDown = tree.Jet_pt_jesSubTotalAbsoluteDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_SubTotalMCDown = tree.Jet_pt_jesSubTotalMCDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TotalDown = tree.Jet_pt_jesTotalDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TotalNoFlavorDown = tree.Jet_pt_jesTotalNoFlavorDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TotalNoTimeDown = tree.Jet_pt_jesTotalNoTimeDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TotalNoFlavorNoTimeDown = tree.Jet_pt_jesTotalNoFlavorNoTimeDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FlavorZJetDown = tree.Jet_pt_jesFlavorZJetDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FlavorPhotonJetDown = tree.Jet_pt_jesFlavorPhotonJetDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FlavorPureGluonDown = tree.Jet_pt_jesFlavorPureGluonDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FlavorPureQuarkDown = tree.Jet_pt_jesFlavorPureQuarkDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FlavorPureCharmDown = tree.Jet_pt_jesFlavorPureCharmDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_FlavorPureBottomDown = tree.Jet_pt_jesFlavorPureBottomDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TimeRunBDown = tree.Jet_pt_jesTimeRunBDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TimeRunCDown = tree.Jet_pt_jesTimeRunCDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TimeRunDDown = tree.Jet_pt_jesTimeRunDDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TimeRunEDown = tree.Jet_pt_jesTimeRunEDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_TimeRunFDown = tree.Jet_pt_jesTimeRunFDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_CorrelationGroupMPFInSituDown = tree.Jet_pt_jesCorrelationGroupMPFInSituDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_CorrelationGroupIntercalibrationDown = tree.Jet_pt_jesCorrelationGroupIntercalibrationDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_CorrelationGroupbJESDown = tree.Jet_pt_jesCorrelationGroupbJESDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_CorrelationGroupFlavorDown = tree.Jet_pt_jesCorrelationGroupFlavorDown[n] / (tree.Jet_pt_nom[n] / self.corr)
        self.corr_CorrelationGroupUncorrelatedDown = tree.Jet_pt_jesCorrelationGroupUncorrelatedDown[n] / (tree.Jet_pt_nom[n] / self.corr)
