...
class Jet:
    def __init__(self, tree, n):
        ...
        self.btagWeightCSV_up_jesAbsoluteMPFBias = tree.Jet_btagWeightCSV_up_jesAbsoluteMPFBias[n];
        self.btagWeightCSV_down_jesAbsoluteMPFBias = tree.Jet_btagWeightCSV_down_jesAbsoluteMPFBias[n];
        self.btagWeightCSV_up_jesAbsoluteScale = tree.Jet_btagWeightCSV_up_jesAbsoluteScale[n];
        self.btagWeightCSV_down_jesAbsoluteScale = tree.Jet_btagWeightCSV_down_jesAbsoluteScale[n];
        self.btagWeightCSV_up_jesFlavorQCD = tree.Jet_btagWeightCSV_up_jesFlavorQCD[n];
        self.btagWeightCSV_down_jesFlavorQCD = tree.Jet_btagWeightCSV_down_jesFlavorQCD[n];
        self.btagWeightCSV_up_jesPileUpDataMC = tree.Jet_btagWeightCSV_up_jesPileUpDataMC[n];
        self.btagWeightCSV_down_jesPileUpDataMC = tree.Jet_btagWeightCSV_down_jesPileUpDataMC[n];
        self.btagWeightCSV_up_jesPileUpPtBB = tree.Jet_btagWeightCSV_up_jesPileUpPtBB[n];
        self.btagWeightCSV_down_jesPileUpPtBB = tree.Jet_btagWeightCSV_down_jesPileUpPtBB[n];
        self.btagWeightCSV_up_jesPileUpPtEC1 = tree.Jet_btagWeightCSV_up_jesPileUpPtEC1[n];
        self.btagWeightCSV_down_jesPileUpPtEC1 = tree.Jet_btagWeightCSV_down_jesPileUpPtEC1[n];
        self.btagWeightCSV_up_jesPileUpPtRef = tree.Jet_btagWeightCSV_up_jesPileUpPtRef[n];
        self.btagWeightCSV_down_jesPileUpPtRef = tree.Jet_btagWeightCSV_down_jesPileUpPtRef[n];
        self.btagWeightCSV_up_jesRelativeFSR = tree.Jet_btagWeightCSV_up_jesRelativeFSR[n];
        self.btagWeightCSV_down_jesRelativeFSR = tree.Jet_btagWeightCSV_down_jesRelativeFSR[n];
        self.btagWeightCSV_up_jesSinglePionECAL = tree.Jet_btagWeightCSV_up_jesSinglePionECAL[n];
        self.btagWeightCSV_down_jesSinglePionECAL = tree.Jet_btagWeightCSV_down_jesSinglePionECAL[n];
        self.btagWeightCSV_up_jesSinglePionHCAL = tree.Jet_btagWeightCSV_up_jesSinglePionHCAL[n];
        self.btagWeightCSV_down_jesSinglePionHCAL = tree.Jet_btagWeightCSV_down_jesSinglePionHCAL[n];
        self.btagWeightCSV_up_jesTimePtEta = tree.Jet_btagWeightCSV_up_jesTimePtEta[n];
        self.btagWeightCSV_down_jesTimePtEta = tree.Jet_btagWeightCSV_down_jesTimePtEta[n];
