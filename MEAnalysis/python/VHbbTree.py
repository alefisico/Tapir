...
class SubjetAK08softdrop:
    def __init__(self, tree, n):
        ...
        self.corr_TimeRunEUp = tree.SubjetAK08softdrop_corr_TimeRunEUp[n];
        self.corr_TimeRunEDown = tree.SubjetAK08softdrop_corr_TimeRunEDown[n];
        self.corr_TimeRunFUp = tree.SubjetAK08softdrop_corr_TimeRunFUp[n];
        self.corr_TimeRunFDown = tree.SubjetAK08softdrop_corr_TimeRunFDown[n];
        self.corr_TimeRunGHUp = tree.SubjetAK08softdrop_corr_TimeRunGHUp[n];
        self.corr_TimeRunGHDown = tree.SubjetAK08softdrop_corr_TimeRunGHDown[n];
...
class SubjetCA15subjetfiltered:
    def __init__(self, tree, n):
        ...
        self.corr_TimeRunEUp = tree.SubjetCA15subjetfiltered_corr_TimeRunEUp[n];
        self.corr_TimeRunEDown = tree.SubjetCA15subjetfiltered_corr_TimeRunEDown[n];
        self.corr_TimeRunFUp = tree.SubjetCA15subjetfiltered_corr_TimeRunFUp[n];
        self.corr_TimeRunFDown = tree.SubjetCA15subjetfiltered_corr_TimeRunFDown[n];
        self.corr_TimeRunGHUp = tree.SubjetCA15subjetfiltered_corr_TimeRunGHUp[n];
        self.corr_TimeRunGHDown = tree.SubjetCA15subjetfiltered_corr_TimeRunGHDown[n];
...
class httCandidates:
    def __init__(self, tree, n):
        ...
        self.sjW1_corr_TimeRunEUp = tree.httCandidates_sjW1_corr_TimeRunEUp[n];
        self.sjW1_corr_TimeRunEDown = tree.httCandidates_sjW1_corr_TimeRunEDown[n];
        self.sjW1_corr_TimeRunFUp = tree.httCandidates_sjW1_corr_TimeRunFUp[n];
        self.sjW1_corr_TimeRunFDown = tree.httCandidates_sjW1_corr_TimeRunFDown[n];
        self.sjW1_corr_TimeRunGHUp = tree.httCandidates_sjW1_corr_TimeRunGHUp[n];
        self.sjW1_corr_TimeRunGHDown = tree.httCandidates_sjW1_corr_TimeRunGHDown[n];
        ...
        self.sjW2_corr_TimeRunEUp = tree.httCandidates_sjW2_corr_TimeRunEUp[n];
        self.sjW2_corr_TimeRunEDown = tree.httCandidates_sjW2_corr_TimeRunEDown[n];
        self.sjW2_corr_TimeRunFUp = tree.httCandidates_sjW2_corr_TimeRunFUp[n];
        self.sjW2_corr_TimeRunFDown = tree.httCandidates_sjW2_corr_TimeRunFDown[n];
        self.sjW2_corr_TimeRunGHUp = tree.httCandidates_sjW2_corr_TimeRunGHUp[n];
        self.sjW2_corr_TimeRunGHDown = tree.httCandidates_sjW2_corr_TimeRunGHDown[n];
        ...
        self.sjNonW_corr_TimeRunEUp = tree.httCandidates_sjNonW_corr_TimeRunEUp[n];
        self.sjNonW_corr_TimeRunEDown = tree.httCandidates_sjNonW_corr_TimeRunEDown[n];
        self.sjNonW_corr_TimeRunFUp = tree.httCandidates_sjNonW_corr_TimeRunFUp[n];
        self.sjNonW_corr_TimeRunFDown = tree.httCandidates_sjNonW_corr_TimeRunFDown[n];
        self.sjNonW_corr_TimeRunGHUp = tree.httCandidates_sjNonW_corr_TimeRunGHUp[n];
        self.sjNonW_corr_TimeRunGHDown = tree.httCandidates_sjNonW_corr_TimeRunGHDown[n];
...
class Jet:
    def __init__(self, tree, n):
        ...
        self.corr_TimeRunEUp = tree.Jet_corr_TimeRunEUp[n];
        self.corr_TimeRunEDown = tree.Jet_corr_TimeRunEDown[n];
        self.corr_TimeRunFUp = tree.Jet_corr_TimeRunFUp[n];
        self.corr_TimeRunFDown = tree.Jet_corr_TimeRunFDown[n];
        self.corr_TimeRunGHUp = tree.Jet_corr_TimeRunGHUp[n];
        self.corr_TimeRunGHDown = tree.Jet_corr_TimeRunGHDown[n];
