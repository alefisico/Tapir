...
for l in full_file_names:
    ...
    for event in ttree :
        ...
        event.GenHiggsBoson = filter(lambda x: (x.pt > 150 and abs(x.eta) < 2.4), event.GenHiggsBoson)
        ...
        nFat["dl"]["HCA15"].Fill(len(event.FatjetCA15SoftDrop)) #These are after basic pt, eta cuts!
        nFat["dl"]["HAK8"].Fill(len(event.FatjetAK8)) #These are after basic pt, eta cuts!
	    ...
	    i.matched = "unmatched"
            Distributions["dl"]["HCA15"][i.matched]["pt"].Fill(i.pt)
            btag1 = event.FatjetCA15SoftDropSubjets[i.subJetIdx1].btag
            btag2 = event.FatjetCA15SoftDropSubjets[i.subJetIdx2].btag
            Distributions["dl"]["HCA15"][i.matched]["btag1"].Fill(max(btag1,btag2))
            Distributions["dl"]["HCA15"][i.matched]["btag2"].Fill(min(btag1,btag2))
            Distributions["dl"]["HCA15"][i.matched]["bbtag"].Fill(i.bbtag)
            MatchedUngroomedFatjet = MatchToCand(i,event.FatjetCA15)
            Distributions["dl"]["HCA15"][i.matched]["mass"].Fill(MatchedUngroomedFatjet.mass)
            Distributions["dl"]["HCA15"][i.matched]["softdropmass"].Fill(i.mass)
            Distributions["dl"]["HCA15"][i.matched]["tau21"].Fill(i.tau21)
	    ...
	    i.matched = "unmatched"
            Distributions["dl"]["HAK8"][i.matched]["pt"].Fill(i.pt)
            Distributions["dl"]["HAK8"][i.matched]["bbtag"].Fill(i.bbtag)
            Distributions["dl"]["HAK8"][i.matched]["mass"].Fill(i.mass)
            Distributions["dl"]["HAK8"][i.matched]["softdropmass"].Fill(i.msoftdrop)
            Distributions["dl"]["HAK8"][i.matched]["tau21"].Fill(i.tau21)
...
results = ROOT.TFile("DLOptimization_TTbar.root","recreate")
for i in cats:
    Count[i].Write()
    for j in scenarios:
        nFat[i][j].Write()
        #if Count[i].GetEntries() > 0:
        #    matchedFatjet[i][j].Scale(1/Count[i].GetEntries())
