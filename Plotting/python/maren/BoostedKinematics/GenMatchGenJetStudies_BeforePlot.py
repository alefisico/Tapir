...
full_file_names = {}
full_file_names["tth"] = "/mnt/t3nfs01/data01/shome/mameinha/tth/gc/GenMatchGenJetStudies/GC596b1622f891/ttHTobb_M125_TuneCP5_13TeV-powheg-pythia8.root"
full_file_names["ttSL"] = "/mnt/t3nfs01/data01/shome/mameinha/tth/gc/GenMatchGenJetStudies/GC596b1622f891/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8.root"
info = {}
info["tth"] = {}
info["ttSL"] = {}
...
for l in full_file_names:
    ...
    results = ROOT.TFile("/mnt/t3nfs01/data01/shome/mameinha/tth/gc/GenMatchGenJetStudies/May14_{}_processed.root".format(l),"recreate")
    f.GetList().Write() 
    for lumi in targetlumi:
