...
class GenTTHAnalyzerPre(Module):
    """
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        self.out.branch("cat_gen",  "I", title="top decay category (-1 unknown, 0 single-leptonic, 1 di-leptonic, 2 fully hadronic)");
        pass
    ...
    def analyze(self, event):
        ...
        LOG_MODULE_NAME.debug("GenTTHAnalyzerPre started")
        ...
        self.out.fillBranch("cat_gen", event.cat_gen_n)

        return True

class GenTTHAnalyzer(Module):
    """
    Analyzes the ttbar (and Higgs) system on gen level.
    Identifies leptonic and hadronic gen top quarks.
    """
