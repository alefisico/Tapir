...
git clone ssh://git@gitlab.cern.ch:7999/Zurich_ttH/tthbb13.git TTH --branch addingDNN
...
git clone ssh://git@gitlab.cern.ch:7999/chreisse/TTH_massfit.git TTH/DNN
